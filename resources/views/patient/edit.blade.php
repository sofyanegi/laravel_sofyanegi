    ...
    <div class="container-fluid">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-2">
            <h1 class="h3 mb-0 fw-bold">
                <i class="bi bi-hospital me-2"></i> Edit Pasien
            </h1>
        </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('patient.update', $patient->id) }}" method="POST" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input id="name" type="text" name="name"
                            ...
                            value="{{ old('name', $patient->name) }}" required placeholder="Masukkan nama pasien">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="address" name="address" rows="3" class="form-control @error('address') is-invalid @enderror"
                            required placeholder="Masukkan alamat pasien">{{ old('address', $patient->address) }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input id="telephone_number" type="text" name="telephone_number"
                            ...
                            value="{{ old('telephone_number', $patient->telephone_number) }}" required placeholder="08xxxx">
