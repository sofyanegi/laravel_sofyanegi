...
@section('dashboard-content')
    <div class="container-fluid">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('hospital.store') }}" method="POST" novalidate>
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="address" name="address" rows="3" class="form-control @error('address') is-invalid @enderror"
                            required placeholder="Masukkan alamat rumah sakit">{{ old('address') }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="email" type="email" name="email"
                                ...
                                required placeholder="contoh@mail.com">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
